...
export const Footer = () => {
    return (
        <footer className="max-w-7xl mx-auto px-6 lg:px-8 py-12 border-t border-white/5">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
                <div className="md:col-span-2">
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <span className="text-lg font-bold font-['Instrument_Sans']">Steam Library</span>
                    </div>
                    <p className="text-sm text-slate-400 max-w-md">
                        Платформа для управления игровой библиотекой Steam с расширенной статистикой и аналитикой.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <Link href="#features" className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">Возможности</Link>
                        <Link href={route('login')} className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">Войти</Link>
                        {/*<Link href={route('register')} className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">Регистрация</Link>*/}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <Link href="#" className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">О проекте</Link>
                        <Link href="#" className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">API Steam</Link>
                        <Link href="#" className="block text-sm text-slate-400 hover:text-blue-400 transition-colors">Политика конфиденциальности</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="pt-8 border-t border-white/5 text-center">
                <p className="text-xs text-slate-500">
                    © {new Date().getFullYear()} Steam Library. Не аффилирован с Valve Corporation или Steam.
                    Все игровые данные предоставлены Steam Web API.
                </p>
            </div>
        </footer>
    );

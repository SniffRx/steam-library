                ...
                <div
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div
                            ...
                            <p className="text-center">Steam Library Project, please authorize if you want use this.</p>
                            <svg width="100px" height="100px" viewBox="0 0 32 32" fill="none"
                                ...
                                <path
                                    ...
                                    fill="white" />
                                <defs>
                                    <linearGradient id="paint0_linear_87_8314" x1="16.0056" y1="2" x2="16.0056" y2="30"
